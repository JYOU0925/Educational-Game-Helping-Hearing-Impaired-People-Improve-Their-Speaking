  ...
  navigator.mediaDevices.getUserMedia({ audio: true })
    .then(function(stream) {
      ...
      function sendData() {
        ...
        fetch('http://127.0.0.1:5501/process_audio', { // Modify the URL to match your Flask API endpoint
          method: 'POST',
          headers: {
...
scrn.addEventListener("click", () => {
  switch (state.curr) {
    ...
    case state.gameOver:
      ...
      UI.score.curr = 0;
      SFX.played = false;
      stopListening(); // Stop listening when the game enters 'gameOver' state
      break;
  }
});
